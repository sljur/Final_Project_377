...
public final class FavoriteCityDatabase_Impl extends FavoriteCityDatabase {
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(FavoriteCityDao.class, FavoriteCityDao_FavoriteCityDatabase_Impl.getRequiredConverters());
  ...
  public FavoriteCityDao favoriteCityDao() {
    if (_favoriteCityDao != null) {
      ...
      synchronized(this) {
        if(_favoriteCityDao == null) {
          _favoriteCityDao = new FavoriteCityDao_FavoriteCityDatabase_Impl(this);
        }
        return _favoriteCityDao;
      }
    }
